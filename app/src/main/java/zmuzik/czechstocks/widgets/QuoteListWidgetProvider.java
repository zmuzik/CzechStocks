...
public class QuoteListWidgetProvider extends AppWidgetProvider {
    ...
    public static final String TAG = "QuoteListWidgetProvider";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        ComponentName name = new ComponentName(context, QuoteListWidgetProvider.class);
        ...
        if (PortfolioWidgetProvider.ACTION_WIDGETS_REFRESH.equals(action)) {
    ...
    static void refreshAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        intent.setData(uri);
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widget_quote_list);
        ...
        Intent refreshIntent = new Intent(context, QuoteListWidgetProvider.class);
